...
/**
 * Dialog for picking the folder that will be used as workspace for ezRepo Designer.
 * <p>
 * 
...
public class PickWorkspaceDialog extends TitleAreaDialog {
	...
	// the name of the default workspace for ezRepo Designer installation (also for back-compatibility)
