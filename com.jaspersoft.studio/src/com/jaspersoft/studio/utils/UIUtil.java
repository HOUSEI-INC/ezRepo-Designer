...
public class UIUtil {
	...
	public enum EditorExtension {
		JRXML(FileExtension.PointJRXML), JRCTX(FileExtension.PointJRCTX), JRTX(FileExtension.JRTX), JASPER(FileExtension.PointJASPER), JRPRINT(FileExtension.PointJRPRINT), JRPXML(".jrpxml"),
		JSSCE(".jssce");
