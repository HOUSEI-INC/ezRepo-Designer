 ...
 * Differently from a {@link MReportPartContainer} this provide properties and
 * methods to configure the group
 */
public class MGroupReportPartContainer extends MReportPartContainer {
	...
	/**
	 * We want to display a meaningful name for this part. The name of the group is
	 * more than logical, but a better value for the label. We use a custom
	 * properties for this
	 */
	@Override
	public String getDisplayText() {
		if (isDetail()) {
			...
			return ModelUtils.getReportPropertyValue(getJasperDesign(),
