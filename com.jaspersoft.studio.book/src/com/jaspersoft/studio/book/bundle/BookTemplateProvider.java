...
public class BookTemplateProvider implements TemplateProvider {
	...
	public List<TemplateBundle> getTemplateBundles() {
		...
		if (cache == null){
			...
			Enumeration<?> en = JaspersoftStudioPlugin.getInstance().getBundle().findEntries("templates/book", "*"+ FileExtension.PointJRXML, false); //Doesn't search in the subdirectories
