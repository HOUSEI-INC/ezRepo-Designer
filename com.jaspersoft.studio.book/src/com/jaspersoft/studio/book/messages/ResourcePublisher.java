...
public class ResourcePublisher extends IResourcesInput{
	...
	protected List<AbstractResourceDefinition> initializeProperties(){
		...
		result.add(new PackageResourceDefinition("en_EN", 
																						 ...
																						 "messages.properties", 
																						 "In this file there are the standard strings used by the Report Book plugin of ezRepo Designer",
																						 getClassLoader(),
		...
		result.add(new PackageResourceDefinition("en_EN", 
																						 ...
																						 "In this file there are the standard strings used by the Report Book of ezRepo Designer, used dinamically",
																						 getClassLoader(),
